...
const CurrentPresidentCard = ({ currentPresident, selectedOrg }) => {
  ...
  const profilePictureUrl = profilePicture
    ? `${DOCU_API_ROUTER}/${president.organizationProfile}/${profilePicture}`
    : null;
  ...
  const handleDropdownAction = (id) => {
    ...
    if (isDeanUpdated || isSduCoorUpdated || !isAdviserValid) {
      ...
      if (isDeanUpdated) {
        ...
        setConfirmMessage(
          "This President Profile has already been updated by the SDU Coordinator. Do you want to continue updating it again?"
        );
...
const PresidentCard = ({
  ...
  const profilePictureUrl = president.profilePicture
  ...
  return (
    <div className="bg-white h-full w-full duration-200 p-4 relative">
      ...
      <div className="flex items-center justify-center mb-4 relative">
        ...
        <div
          className={`w-32 h-32 bg-indigo-100 rounded-full flex items-center justify-center border-2 border-gray-200 ${
      ...
      <div className="text-center space-y-2">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <p>
            {president.course} - {president.year}
          </p>
          ...
          <p>
            ...
            <span>
              {president.presentAddress?.fullAddress ||
                president.permanentAddress?.fullAddress}
            </span>
          </p>
          <p>
