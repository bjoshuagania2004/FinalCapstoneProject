...
import { ShowSduDetailedProposal } from "./sdu-detailed-proposal";

export function SduIndividualProposalConduct({ orgData, user }) {
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-auto bg-gray-200">
      ...
      <h1 className="text-2xl p-4 font-bold drop-shadow-lg">Proposals</h1>
